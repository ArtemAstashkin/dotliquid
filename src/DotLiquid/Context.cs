...
namespace DotLiquid
{
    ...
    public class Context
    {
        ...
        private static readonly Lazy<Regex> SquareBracketedRegex = new Lazy<Regex>(() => new Regex(
            R.Q(@"^\[(.*)\]$"),
        ...
        private object Variable(string markup, bool notifyNotFound)
        {
            ...
            Match firstPartSquareBracketedMatch = SquareBracketedRegex.Value.Match(firstPart);
            ...
            for (int i = 1; i < parts.Count; ++i)
            {
                ...
                Match partSquareBracketedMatch = SquareBracketedRegex.Value.Match(forEachPart);
